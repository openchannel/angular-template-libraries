...
export class OcRichTextEditorComponent implements OnInit, ControlValueAccessor {
  ...
  public tinyOptions = {
    ...
    suffix: '.min',
    menubar: false,
    toolbar: 'formatselect | bold italic underline strikethrough subscript superscript fontselect fontsizeselect |' +
    ...
    mobile: {
      ...
      max_height: 300,
      height: 220,
      toolbar: 'formatselect | bold italic underline strikethrough | undo redo | fontselect fontsizeselect | numlist bullist | ' +
