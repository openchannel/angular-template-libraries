...
describe('OcForgotPasswordComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [OcForgotPasswordComponent, MockLabelComponent, MockInputComponent, MockErrorComponent,
        MockButtonComponent, MockSvgIconComponent, MockRoutingComponent],
      providers: [NgModel],
