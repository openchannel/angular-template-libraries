import { FileDetails, OcFormComponent, OcFormComponentsModule } from 'oc-ng-common-component/src/lib/form-components';
    ...
    if (videoUrl === 'https://www.youtube.com/watch?v=DGQwd1_dpuc') {
      return of({
        ...
        meta: {
          ...
          likes: '58760',
          duration: 10913,
          description: 'Relaxing music with beautiful nature videos for ultimate relaxation.' +
